              ...
              <div className="bg-card rounded-2xl border border-border p-8 relative overflow-hidden">
                ...
                <div className="relative z-10 text-center mb-8">
                  <div className="inline-block px-6 py-2 rounded-full bg-amber-500/10 mb-4">
                    <span className="font-['Montserrat'] text-4xl font-bold text-[#1f3759]">6%</span>
                  </div>
                  <p className="font-['Anek_Kannada'] font-semibold text-sm text-[#1f3759]/80">Starting Interest</p>
                </div>
                <div className="bg-muted/50 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex justify-between">
                      ...
                      <span className="font-['Montserrat'] font-bold text-[#960f1e] text-lg">₹9,666</span>
                    </div>
                  </div>
                </div>
              </div>
