...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.microfinanceDesc": "Get quick and flexible site loans to purchase land and start building your dream property. Our loan options are designed to make land ownership simple, affordable, and accessible for everyone.",
    "services.microfinanceF1": "6% - 12% Interest Rate",
    "services.microfinanceF2": "Flexible Loan Amounts",
    "services.microfinanceF3": "No CIBIL Score Required",

    "services.construction": "Construction Loans",
    "services.constructionDesc": "Build your dream home with our flexible construction loan options designed to support you at every stage of the building process. We provide reliable financing with simple procedures and transparent terms.",
    "services.constructionF1": "Loan Amount up to ₹15 Lakhs",
    "services.constructionF2": "50% Advance Option Available",
    "services.constructionF3": "EMI Starts After Completion",

    "services.pigmy": "Pigmy Collection",
    "services.pigmyDesc": "A convenient door-to-door daily savings collection service designed to help individuals and small business owners save money regularly with ease and discipline.",
    "services.pigmyF1": "Start Saving from Just ₹10 per Day",
    "services.pigmyF2": "Daily Door-to-Door Collection",
    "services.pigmyF3": "Easy Withdrawal Options",
